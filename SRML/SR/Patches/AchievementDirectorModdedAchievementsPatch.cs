...
namespace SRML.SR.Patches
{
    ...
    internal static class AchievementDirectorModdedAchievementsPatch
    {
        ...
        {
            foreach (KeyValuePair<AchievementsDirector.Achievement, Tuple<AchievementsDirector.Tracker, AchievementRegistry.Tier>> ach in AchievementRegistry.moddedAchievements)
            {
