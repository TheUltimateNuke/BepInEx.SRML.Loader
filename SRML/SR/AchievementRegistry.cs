...
namespace SRML.SR
{
    ...
    {
        internal static Dictionary<AchievementsDirector.Achievement, Tuple<AchievementsDirector.Tracker, Tier>> moddedAchievements = new Dictionary<AchievementsDirector.Achievement, Tuple<AchievementsDirector.Tracker, Tier>>();
        ...
        public static void RegisterModdedAchievement(AchievementsDirector.Achievement ach, AchievementsDirector.Tracker track, Tier tier) => 
            moddedAchievements.Add(ach, new Tuple<AchievementsDirector.Tracker, Tier>(track, tier));
