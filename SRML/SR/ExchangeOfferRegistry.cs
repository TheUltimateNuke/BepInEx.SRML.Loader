...
namespace SRML.SR
{
    public static class ExchangeOfferRegistry
    {
        ...
        internal static Dictionary<Tuple<ExchangeDirector.Category, Identifiable.Id[]>, SRMod> customCategories = new Dictionary<Tuple<ExchangeDirector.Category, Identifiable.Id[]>, SRMod>();
        ...
        public static void RegisterCategory(ExchangeDirector.Category category, Identifiable.Id[] ids) => customCategories.Add(new Tuple<ExchangeDirector.Category, Identifiable.Id[]>(category, ids), SRMod.GetCurrentMod());
